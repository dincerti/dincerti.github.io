...
# Overview
hesim is an R package for health-economic simulation modeling and decision analysis. The most recent release, v0.2.0, is now on [CRAN](https://cran.r-project.org/web/packages/hesim/index.html) with new support for simulating partitioned survival models (PSMs) and continuous-time state transition models (CTSTMs). Documentation is provided on the package [website](https://hesim-dev.github.io/hesim/).
...
<img src="/figs/hesim_stprobs-1.png" title="plot of chunk hesim_stprobs" alt="plot of chunk hesim_stprobs" style="display: block; margin: auto;" />
