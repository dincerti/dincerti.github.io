...
\subsubsectionfont{\rmfamily\mdseries\Large\bf} % Using 3rd level header for website
...
% align description list
\usepackage{enumitem}
\setlist[description]{labelindent=0pt,style=multiline,leftmargin=2cm}
\def\tightlist{} 
