...
The elapsed times (in seconds) suggest that `hesim` is ```r round(time_mstate[["elapsed"]]/time_hesim[["elapsed"]], 2)``` faster than `mstate` when simulating a parametric multi-state model.
